...
<body>
    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a  style="color: #760000" id="LinkAcme" name="LinkAcme" class="navbar-brand" href="#"><i class="fa fa-flask"></i> <span class="light"></span> FarmasApp</a>

                @if(Auth::guest())
                    <a style="color: #760000" id="LinkAcme" name="LinkAcme" class="navbar-brand" href="{{ url('/login') }}"></span> Iniciar Sesión</a>
                    <a style="color: #760000" id="LinkAcme" name="LinkAcme" class="navbar-brand" href="{{ url('/registro') }}"></span> Registrarse</a>
                @else
                    <a style="color: #760000" id="LinkAcme" name="LinkAcme" class="navbar-brand" href="/home"></i> <span class="light"></span> {{Auth::user()->name}}</a>
                @endif
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li  id="LinkNossotros" name="LinkInicio">
                        <a  style="color: #250505" id="LinkInicio" name="LinkInicio" href="#">Inicio</a>
                    </li>
                    <li>
                        <a  style="color: #250505" id="LinkCaracteristicas"  name="LinkCaracteristicas" href="#">Nosotros</a>
                    </li>
                    <li>
                        <a  style="color: #250505" id="LinkContacto"  name="LinkContacto" href="#">Contáctanos</a>
                    </li>
    ...
    <header class="intro-header" style="background-image: url('landing/img/preparados3.jpg')">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        ...
                        <br>
                        <br>
                        <h1 style="color: #4C0A0A;">FARMASAPP</h1>
                        <hr class="small">
                        <span style="color: #250505; font-weight: bold;" class="subheading">Todo al alcance de su bolsillo.</span>
                        <br>
                        <br>
                        <br>
                        <br>
...
{{-- fin slidershow --}}
   ...
   <hr> -->
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="container-fluid" id="home" name="home">
                    ...
                    <h2 class="text-center blanco">Todo lo que usted necesita a un módico precio.</h2>
                    <br>
                </div>
            </div>
    ...
    <section id="Caracteristicas">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <p class="text-center"><i class="fa fa-5x fa-home"></i></p>
                <div class="row">
                    <div class="col-sm-8 col-sm-push-2">
                        <p class="text-justify">
                            <i class="fa fa-check-circle-o"></i> Haga su reserva <strong> desde la comodida de su hogar.</strong>
                            
                        </p>
                        <p class="text-justify">
                            <i class="fa fa-check-circle-o"></i> Solo debe adjuntar una <strong>foto de la receta</strong>
                        </p>
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <p class="text-center"><i class="fa fa-5x fa-flask"></i></p>
                <div class="row">
                    <div class="col-sm-8 col-sm-push-2">
                        <p class="text-justify">
                            <i class="fa fa-check-circle-o"></i><strong>Los 50 años de experiencia</strong> de nuestro químico le garantizan un trabajo bien hecho.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="carrusel" style="display: none;">
        <div class="container-fluid">
        ...
        <div class="container" >
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <p class="text-justify"><i class="fa fa-check-circle-o"></i>&nbsp; Las reservas se podrán las 24 horas del día pero se podrán recoger de 8AM a 1 PM y de 3PM a 8PM.&nbsp;</p>
                    {{-- <p class="text-justify"><i class="fa fa-check-circle-o"></i>&nbsp;&nbsp;</p> --}}
                </div>
